...
<body>
	...
	<div id="main-content" class="container">
		...
		<img src="images/liveaction.jpg" alt="Revista Nakayoshi" style="width:260px;height:195px; display: block; margin-left: auto;margin-right: auto;"> 
		<h3>2014</h3>
		<p>
		<b>Sailor Moon Crystal</b> (美 少女 戦 士 セ ー ラ ー ム ン ン Crystal ク リ ス タ ル), és la última adaptació de l'anime en commemoració del 20è aniversari. Produïda per Toei Animation i dirigida per Munehisa Sakai (Temporades 1 i 2) i Chiaki Kon (Temporada 3-present), la sèrie es va transmetre a tot el món a Niconico del 5 de juliol del 2014 al 18 de juliol del 2015. Els episodis de la temporada 1 i 2 van ser emesos dues vegades al mes. En lloc de refer l'anime dels 90 que la precedia, Toei va produir Crystal com a reinici de Sailor Moon i com una adaptació més fidel del manga original, ometent gran part del material original de la primera sèrie. Aquestes dues primeres temporades van ser molt criticades pels fans, ja que el disseny dels personatges era molt pobre. Tot això ho van millorar a la tercera temporada.</p>
		...
		<img src="images/smcrystal.png" alt="Revista Nakayoshi" style="width:260px;height:146px; display: block; margin-left: auto;margin-right: auto;"> 
	</div>
<?php
	require "footer.php";
?>
